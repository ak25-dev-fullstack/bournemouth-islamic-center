          ...
          <div>
            ...
            >
              ...
              <input
                ...
                className="px-3 py-2 rounded-md bg-emerald-800 border border-emerald-700 text-sm text-white placeholder:text-emerald-400 focus:outline-none focus:ring-2 focus:ring-amber-400"
              />
              <button
                type="submit"
                className="px-4 py-2 rounded-md bg-amber-500 text-white text-sm font-semibold hover:bg-amber-600 transition-colors"
              >
                Subscribe
              </button>
            </form>
