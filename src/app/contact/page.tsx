    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-8">
          {/* Address & hours */}
          <div>
            <h2 className="text-base font-bold text-stone-800 mb-4">Find Us</h2>
            <div className="bg-white rounded-xl border border-stone-200 p-5 space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <address className="not-italic text-sm text-stone-700">123 Mosque Road, Bournemouth, BH1 1AA</address>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+441202000000" className="text-sm text-stone-700 hover:text-emerald-700 transition-colors">01202 000 000</a>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@bournemouth-ic.org.uk" className="text-sm text-stone-700 hover:text-emerald-700 transition-colors">info@bournemouth-ic.org.uk</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="rounded-xl overflow-hidden border border-stone-200 h-80">
              <iframe
          ...
          {/* Visiting info */}
          <div>
            <h2 className="text-base font-bold text-stone-800 mb-4">Visiting Information</h2>
        ...
        {/* Right: Contact form */}
        <div>
          <h2 className="text-base font-bold text-stone-800 mb-4">Send a Message</h2>
          <div className="bg-white rounded-xl border border-stone-200 p-6">
            {status === "success" ? (
              <div className="text-center py-12">
                <div className="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-emerald-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <h3 className="text-base font-bold text-stone-800 mb-2">Message Sent</h3>
                <p className="text-stone-500 text-sm">JazakAllah khayran. We will be in touch as soon as possible.</p>
                <button
                  onClick={() => setStatus("idle")}
                  className="mt-6 text-sm text-emerald-700 hover:text-emerald-900 font-medium transition-colors"
                >
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="topic" className="block text-xs font-medium text-stone-700 mb-1">Subject</label>
                  <select
                    id="topic"
                    name="topic"
                ...
                <button
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-emerald-700 text-white text-sm font-semibold hover:bg-emerald-800 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                >
